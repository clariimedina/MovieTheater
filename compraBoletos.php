...
<div id="main">
	...
	<div class="compra-proceso" style="display:inline-block">
		<div class="compra-proceso-instrucciones">
			<ul>
				<li><strong>1</strong>Seleccionar boletos</li>
				<li><strong>2</strong>Detalles pago</li>
				<li><strong>3</strong>Compra finalizado</li>
			</ul>
		</div>
		<div class="compra-proceso-seleccionboletos"></div>
	</div>
</div>
